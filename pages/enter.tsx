...
export default function Enter() {
  ...
  return (
    <div className="mt-16 px-4">
      <h3 className="text-center text-3xl font-bold">Enter to Kiwi</h3>
      ...
      <div className="mt-8">
        ...
        <form className="mt-8 flex flex-col">
          ...
          <button
            className="mt-6 rounded-md border border-transparent bg-orange-500 px-4 py-2
            text-sm font-medium text-white shadow-sm hover:bg-orange-600 focus:outline-none
        ...
        <div className="mt-8">
          ...
          <div className="mt-2 grid grid-cols-2 gap-3">
            ...
            py-2 px-4 text-sm font-medium text-gray-500 shadow-sm hover:bg-gray-50"
            >
              <svg
                className="h-5 w-5"
                aria-hidden="true"
